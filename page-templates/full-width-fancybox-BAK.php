                   ...
                   <?php  //$categories = get_terms('project_category', array( 'hide_empty' => 0 ));  ?>
                    ...
                    <div class="filterbar container">
                        <div class="row">
                            ...
                            ?>
                            <ul id="category-menu">
                            <li class="selected"><a class="showall ajax"  onclick="cat_ajax_get('<?php echo $categories; ?>');"  id="defaultclick">ALL PROJECTS</a></li>
...
<script>
    ...
    /*function triggergalleryinit() {
        $('.firstgalleryimg').click();
        document.getElementsByClassName('firstgalleryimg').click();
